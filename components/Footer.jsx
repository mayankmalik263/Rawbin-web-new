...
export default function Footer() {
  return (
    <footer className="bg-bg-main pt-20 pb-10 border-t border-black/5 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-text-muted text-sm font-medium">
              ...
              <a href="mailto:compost@rawbin.in" className="hover:text-primary transition-colors">Contact Us</a>
