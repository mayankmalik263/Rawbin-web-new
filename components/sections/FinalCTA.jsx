    ...
    <section id="order" className="bg-white py-24">
      <div className="max-w-[800px] mx-auto px-5 text-center">
        ...
        >
          ...
          <Link href="#contact" className="bg-bg-alt text-nc-text border border-black/5 px-10 py-5 rounded-full font-bold text-lg tracking-wide hover:bg-black/5 transition-colors">
            CONTACT US
          </Link>
        </motion.div>
